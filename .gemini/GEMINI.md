...
You are working in a **SAFe multi-agent development environment** using the REN (RenderTrust) Agentic Workflow methodology.
...
> **Tip**: If your team uses GitHub-Linear auto-sync, tickets referenced in commit messages (e.g., `[REN-123]`) auto-move to Done when the PR merges. Manually close child stories not referenced in commits.

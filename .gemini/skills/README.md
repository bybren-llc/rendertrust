...
These skills are part of the **RenderTrust** multi-agent harness for Gemini CLI.
...
The skill system architecture and REN harness methodology are the intellectual property of J. Scott Graham and ByBren, LLC.

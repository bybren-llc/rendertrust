...
tools: [Read, Bash, mcp__claude_ai_Linear__*, mcp__claude_ai_Atlassian__*]
model: sonnet
---
...
- PR #123: [REN-XXX] - [Status]
- PR #124: [REN-XXX] - [Status]
...
```bash
# Agent 1: FE Developer on REN-123
# Agent 2: BE Developer on REN-124
...
```bash
# Agent 1: DE creates migration (REN-125)
# Agent 2: BE implements API (REN-126) - depends on REN-125
# TDM ensures REN-125 merged before REN-126 starts
```

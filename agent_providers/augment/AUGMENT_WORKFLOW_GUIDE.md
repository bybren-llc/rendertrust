# Augment Starter Kit for RenderTrust SAFe-Agentic-Workflow

## Overview

This directory contains the starter kit for using the RenderTrust SAFe-Agentic-Workflow with Augment. Unlike the Claude Code "golden path" which is fully automated, this path requires some manual setup and adaptation.

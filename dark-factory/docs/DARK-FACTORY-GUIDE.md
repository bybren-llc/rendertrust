...
git clone git@github.com:ByBren-LLC/rendertrust.git
cd rendertrust
...
./dark-factory/scripts/factory-start.sh story REN-456

# Feature-level work (4-5 agents: TDM + BE + FE + QAS + RTE)
./dark-factory/scripts/factory-start.sh feature REN-123

# Epic-level work (6-8 agents: full SAFe team)
./dark-factory/scripts/factory-start.sh epic REN-789
```

The session name follows the pattern `factory-REN-XXX` (or
...
tail -f ~/.dark-factory/logs/factory-REN-123/be-developer.log

# Search logs for errors
grep -i "error\|fail\|blocked" ~/.dark-factory/logs/factory-REN-123/*.log
```
...
./dark-factory/scripts/factory-attach.sh factory-REN-123

# Attach with a specific pane selected (e.g., pane 2 = BE Developer)
./dark-factory/scripts/factory-attach.sh factory-REN-123 2
```
...
tmux attach -t factory-REN-123 -r
```
...
./dark-factory/scripts/factory-attach.sh factory-REN-123 3

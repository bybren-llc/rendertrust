...
tail -f ~/.dark-factory/logs/factory-REN-42/*.log

# Jump into a specific agent's pane to observe
./dark-factory/scripts/factory-attach.sh factory-REN-42 2

# End of day: Graceful shutdown
./dark-factory/scripts/factory-stop.sh factory-REN-42
```
...
3. Attach read-only: `tmux attach -t factory-REN-42 -r`

...
"""Synchronous HTTP client for the RenderTrust API.
...
Example usage::
    ...
    result_path = client.download_result(job["id"], output_path="./output.bin")
"""
...
class RenderTrustClient:
    """Synchronous client for the RenderTrust API.
    ...
    def __enter__(self) -> RenderTrustClient:
        return self
    ...
    def submit_job(
        ...
        **kwargs: Any,
        ...
        """
        # The dispatch API expects job_type and payload_ref.
    ...
    def download_result(
        ...
        with self._client.stream("GET", download_url) as stream:

...
3. **Stage 3**: HITL (J. Scott Graham) - Final merge authority
...
### NEW (REN-314): Architecture & Governance Owner
...
ls specs/REN-*-spec.md | grep "architecture|enabler"
...
cat specs/REN-XXX-similar-feature-spec.md
```
...
2. **Technical Implementation Details**:
   ...
   - Fits into existing RenderTrust architecture?
...
cat specs/REN-XXX-similar-spec.md
```
...
- Spec: specs/REN-YYY-{feature}-spec.md
- Linear: REN-YYY
```
...
# Use mcp__claude_ai_Linear__get_issue to load full context
```
...
```markdown
## System Architect PR Review - REN-XXX (PR #XXX)
...
## Pattern Library Maintenance (REN-300)
...
4. **Handoff Statement**
   > "Stage 1 review complete for PR #XXX (REN-YYY). Pattern compliance verified, RLS enforced. Approved for ARCHitect-in-CLI review (Stage 2)."

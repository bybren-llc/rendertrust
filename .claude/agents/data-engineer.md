...
- Atomic commits in SAFe format: `feat(db): description [REN-XXX]`
...
### NEW (REN-314): PROD Migration & Schema Ownership
...
**Migration Plans**: `/docs/agent-outputs/technical-docs/REN-{number}-migration-plan.md`
...
**Naming Convention**: `REN-{number}-migration-plan.md`
...
DATABASE_URL="postgresql://rendertrust:rendertrust_dev@localhost:5432/rendertrust_dev" npx prisma migrate dev --name migration_name
...
# Verify RLS enabled
docker exec -it rendertrust-postgres psql -U rendertrust -d rendertrust_dev \
...
4. **Handoff Statement**
   > "DE implementation complete for REN-XXX. Migration tested, ARCHitect approved. AC/DoD confirmed. Ready for QAS review."

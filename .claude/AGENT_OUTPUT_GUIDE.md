...
| -------------------------------------- | --------------------------------------- | --------------------------------- |
| **QAS** (Quality Assurance Specialist) | `/docs/agent-outputs/qa-validations/`   | `REN-{number}-qa-validation.md`   |
| **BSA** (Business Systems Analyst)     | `/docs/agent-outputs/requirements/`     | `REN-{number}-requirements.md`    |
| **System Architect**                   | `/docs/adr/`                            | `ADR-{number}-{title}.md`         |
| **Tech Writer**                        | `/docs/agent-outputs/technical-docs/`   | `REN-{number}-technical-docs.md`  |
| **Data Engineer**                      | `/docs/agent-outputs/technical-docs/`   | `REN-{number}-migration-plan.md`  |
| **TDM** (Technical Delivery Manager)   | `/docs/agent-outputs/delivery-reports/` | `REN-{number}-delivery-report.md` |
...
**Output Location**: `/docs/agent-outputs/qa-validations/REN-{number}-qa-validation.md`
...
**Output Location**: `/docs/agent-outputs/requirements/REN-{number}-requirements.md`
...
**Output Location**: `/docs/agent-outputs/technical-docs/REN-{number}-technical-docs.md`
...
**Output Location**: `/docs/agent-outputs/technical-docs/REN-{number}-migration-plan.md`
...
cat > /docs/agent-outputs/qa-validations/REN-334-qa-validation.md <<EOF
## QA Validation Report - REN-334
...
cat > /docs/agent-outputs/requirements/REN-335-requirements.md <<EOF
## Requirements - REN-335
...
cat > /docs/agent-outputs/technical-docs/REN-336-migration-guide.md <<EOF
## Migration Guide - REN-336
...
1. **During Work**: Agents write to `/docs/agent-outputs/{category}/REN-{number}-*.md`
...
✅ Use Linear ticket number in filename (`REN-{number}-*`)

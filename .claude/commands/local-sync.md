...
```bash
# Example: REN-381-rename-slash-commands-remote-prefix
git branch -d REN-381-rename-slash-commands-remote-prefix
```
...
```bash
docker ps --filter name=rendertrust --format 'table {{.Names}}\t{{.Status}}\t{{.State}}'
```
...
Latest:        fd85ba3 - feat(marketing): RenderTrust pages [REN-379]
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Docker Services (REN-401: STANDARD Ports)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

rendertrust-dev-app:        ✅ Up 3 hours (healthy) → port 3000
rendertrust-dev-postgres:   ✅ Up 3 hours (healthy) → port 5432
rendertrust-dev-redis:      ✅ Up 3 hours (healthy) → port 6379

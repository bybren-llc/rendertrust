...
gh pr create --title "feat: add feature"  # Missing [REN-XXX]
...
gh pr create --title "feat(scope): description [REN-XXX]"
...
git push --force-with-lease origin REN-XXX-description
```
...
- [ ] Commits follow: `type(scope): description [REN-XXX]`
...
Prompt: "Review PR #XXX for REN-YYY. Validate commit format, CI status, patterns."
```

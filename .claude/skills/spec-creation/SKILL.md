...
4. `test(scope): add unit tests [REN-{number}]`
...
ls specs/
cat specs/SPEC-REN-XXX-example.md
```
...
| ------------ | ----------------------------------------------------- |
| Impl specs   | `specs/SPEC-REN-{number}-{description}.md`            |
| Requirements | `docs/agent-outputs/requirements/REN-{number}-*.md`   |
...
**Spec**: specs/SPEC-REN-{number}-{description}.md

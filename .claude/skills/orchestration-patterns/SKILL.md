...
Prompt: "Review PR #XXX for REN-YYY. Validate:
...
All QAS reports go to: `docs/agent-outputs/qa-validations/REN-{number}-qa-validation.md`
...
- **rendertrust**: Core agentic principles

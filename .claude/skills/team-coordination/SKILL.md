...
```
Create an agent team for REN-XXX implementation.
...
- Task: Implement endpoints per spec at specs/REN-XXX-spec.md
...
JWT (custom) session tokens instead of JWT. Check the updated

...
![Harness](https://img.shields.io/badge/harness-v2.6.0-blue)
...
The skill system architecture and RenderTrust harness methodology are the intellectual property of J. Scott Graham and ByBren, LLC.
...
Enforces SAFe-compliant development workflow with proper branch naming (`REN-{number}-{description}`), standardized commit messages (type, scope, description), and rebase-first git workflow. Ensures all work is traceable to Linear tickets.

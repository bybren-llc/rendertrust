...
Task({
  ...
  prompt:
    "Create comprehensive spec for REN-123 user profile feature. Include pattern discovery, acceptance criteria, and testing strategy. Reference existing patterns from patterns_library/.",
});
```
...
```
@tdm I need to implement REN-123 (user profile feature).
...
- **Example**: BSA should have `tools: [Read, Write, Edit, Bash, Grep, Glob, mcp__claude_ai_Linear__*]`

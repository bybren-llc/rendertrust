...
- [ ] **Bash scripts >100 lines** → MANDATORY System Architect review
  ...
  - REN-XXX Gap: 710-line `deploy-migration-prod.sh` delivered without review

- [ ] **CI/CD workflow created/modified** → MANDATORY System Architect review
  - Example: GitHub Actions workflows, pipeline changes
  - REN-XXX Gap: 641-line `migration-validation.yml` delivered without review
...
- [ ] **Validation/verification scripts >200 lines** → MANDATORY System Architect review
  ...
  - REN-XXX Gap: 3 TypeScript scripts delivered without review
...
- [ ] Branch naming: `REN-{number}-{description}` or `__TICKET_PREFIX__-{number}-{description}`
...
## Example: REN-321 Failure Analysis
...
**This checklist prevents architectural governance gaps like REN-321**

...
The REN project uses a SAFe Agile Release Train (ART) agent team powered by Claude Code.
...
4. **HITL Model**: J. Scott Graham (POPM) has final approval on all deliverables
...
### To POPM (J. Scott Graham) - HITL Model

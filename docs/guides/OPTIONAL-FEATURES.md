...
- [ ] Edit `agent_providers/claude_code/prompts/tech-writer.md` -- remove
      references to Confluence and `claude_ai_Atlassian`
...
- [ ] In `TEMPLATE_SETUP.md`, the `claude_ai_Atlassian` placeholder row
...
4. Start a session: `./dark-factory/scripts/factory-start.sh feature REN-123`

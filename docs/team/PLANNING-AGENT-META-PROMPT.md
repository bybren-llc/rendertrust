...
3. **REN Methodology** - Evidence-Based, Pattern-Driven, Spec-Driven
...
1. **Specs Directory**: `ls specs/REN-*-spec.md | grep "similar"`
...
```bash
cp specs/planning_template.md specs/REN-XXX-{initiative}-planning.md
```
